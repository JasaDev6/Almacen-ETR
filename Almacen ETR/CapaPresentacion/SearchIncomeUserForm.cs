...
{
    public partial class SearchIncomeUserForm : Form
    {
        Conexion conexion = new Conexion();
        private int endeId;

        public SearchIncomeUserForm(string endeName)
        {
            InitializeComponent();
            ...
            {
                endeId = 1;
                LabelTitle.Text = "BUSQUEDA POR USUARIO INGRESOS ENDE TRANSMISIÓN";
            }
            if (endeName.Equals("Corporación"))
            {
                endeId = 2;
                LabelTitle.Text = "BUSQUEDA POR USUARIO INGRESOS ENDE CORPORACIÓN";
            }
        }
        ...
        private void SearchIncomeUserForm_Load(object sender, EventArgs e)
        {
